...
plotPow_MeanSp_difR(comp_ADq10)

ggsave("powADq10_DifReplacement.png", width=6,height=6,units="in",dpi=600)
...
## Simulations to plot spatial patterns with differents replacement Rate
...
#
g <- plotNeutral_SpatPat(64,256,500,"L",c(0,0.001,0.01,0.1))
g
...
# USAR dplyr en calcRankSAD_by (ver SP_simul 428)
```
