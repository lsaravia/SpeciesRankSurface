...
g <- plotDq_Side_Sp(DqT,256,64,"B")
g
setwd("..")
ggsave("Dq_UniLog64_256.png", width=8,height=6,units="in",dpi=600)

g <- plotDq_Side_Sp(DqT,256,0,"B")
g
ggsave("Dq_UniLog_NumSp_256.png", width=8,height=6,units="in",dpi=600)
