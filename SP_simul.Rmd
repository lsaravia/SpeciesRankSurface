...
## Plots for publication uniform SAD 

```{r plots_spDq, eval=T,echo=F,message=F,warning=F}
setwd("Simul")

# Plot of the uniform and randomized spatial pattern for a uniform SAD with 64 species and side=256
#

g <- plotSAD_SpatPat(64,256,"U")
g 
setwd("..")
ggsave("spat_Unif64_256.png", width=8,height=6,units="in",dpi=600)
setwd("Simul")


#
# Plots of Dq with uniform SAD and 20 repetitions!
#
unique(DqT$SAD)
#DqT$Type[DqT$Type=="SRS"] <- "DqSRS"
#DqT$Type[DqT$Type=="rnzSRS"] <- "rnzDqSRS"

rm(Dq1,Dq2,fname,fname1)


g <- plotDq_Side_Sp(DqT,256,64,"Uniform")
g
setwd("..")
ggsave("Dq_Unif64_256.png", width=8,height=4,units="in",dpi=600)

g <- plotDq_Side_Sp(DqT,256,0,"Uniform")
g
ggsave("Dq_Unif_NumSp_256.png", width=8,height=6,units="in",dpi=600)

g <- plotDq_Side_Sp(DqT,512,0,"Uniform")
g
ggsave("Dq_Unif_NumSp_512.png", width=8,height=6,units="in",dpi=600)

#
# Plot R2 for dqSAD dqSRS
#
g <- plotR2Dq_Side_Sp(DqT,256,64,"Uniform")
g
ggsave("R2Dq_Unif_64_256.png", width=8,height=6,units="in",dpi=600) 
...
```{r plots_logser_spDq, eval=T,echo=F,message=F,warning=F}
setwd("Simul")

# Plot of the uniform and randomized spatial pattern for a logseries SAD with 64 species and side=256
#
...
g <- plotSAD_SpatPat(64,256,"L")
g 
setwd("..")
ggsave("spat_Logser64_256.png", width=8,height=6,units="in",dpi=600)

unique(DqT$SAD)

g <- plotDq_Side_Sp(DqT,256,64,"Logseries")
g
ggsave("Dq_Logser64_256.png", width=8,height=4,units="in",dpi=600)
