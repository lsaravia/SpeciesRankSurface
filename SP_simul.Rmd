...
spa <- genUniformSAD_image(64,256)
...
spa <- genUniformSAD_image(64,512)
plot_sed_image(spa,"Banded 64sp")
...
# Generate an image following a logseries distribution with 64 sp 
# an regular spatial distribution
spa <- genFisherSAD_image(64,512)

plot_sed_image(spa,"Regular Fisher  64sp",0,64,10)
