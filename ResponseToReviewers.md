...
* I added a some more interpretations, and about wath we know and what we don't know about Dq. This is why I added the simple toy models to understand more about how D_q is related to SAD and spatial patterns. pag 7:6_28  
...
* these are examples of very simple species gradients and don't intend to be realistic, and mimic in a basic way an enviromental gradient.  
...
* I added an explanation of why this test can be used with D_q pag 9:10-24
...
* I added an explanation about why I use R^2 and delete the rule of thumb. Pag 6:29- Pag 7:1-5
...
* I Eliminated figure 4 with R^2 and add figure 6 with fit for neutral model, and also figures 9-13 in the appendix.
...
* I changed that in the ms. pag 4:25-29 pag 6:1
...
* I added the method used to calculate ranks. pag 6:23-24
...
* More details and figures 1-2 were added in the appendix.
...
* D_0^SRS is the fractal dimension of the species' spatial distribution, which in our model simulations is always 2 because the lattice is always filled. I changed it in the ms. pag 10:23-25
...
* I changed figure 8 to a matrix of plots.
...
* I added an explanation on why I calculate power for 1 dimension, the idea is to show that single components should not be considered for community comparisons due to its high type I error and low power. When you have different methods to perform a test of a hypothesis you allways prefer the one with more power, so it is commoon to compare power of different methods. pag 10:1-5

#7. Figures 1 and 5 lacks color scheme, making them difficult to read.
* I added the labels and changed color palette
...
* That was a mistake in calculating averages, I corrected the calculation of ranks.
...
* This manuscript is about a methodology to compare communities the model was chosen to generate a gradient from  similar and different communities, the comments of the reviewer are very interesting but for a paper about community assembly, that would be another paper...
