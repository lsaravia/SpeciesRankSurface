...
```{r simul_pomac467_T100, eval=T,echo=F,message=F,warning=F}
setwd("Simul")
...
mks1 <- m$mPval
mks1 <- mks1[mks1$method=="DqSAD" & mks1$p.adjust>0.05,]
pander(mks1,caption="DqSAD not different T=1000")

Dq1 <- readNeutral_calcDq(paste0(bName,"T1000mfSAD.txt"))

mergePair_plotDq(mks1[1,],Dq1,"DqSAD not different T=1000")
...
mks1 <- m$mPval
mks1 <- mks1[mks1$method=="DqSAD" & mks1$p.adjust>0.05,]
pander(mks1,caption="DqSAD not different T500")
